 ...
 */
@Entity
@Table(name = "PHASE_TWO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PhaseTwo.findAll", query = "SELECT p FROM PhaseTwo p"),
    @NamedQuery(name = "PhaseTwo.findByPhasenumber", query = "SELECT p FROM PhaseTwo p WHERE p.phasenumber = :phasenumber")})
public class PhaseTwo implements Serializable {
    ...
    public PhaseTwo(BigDecimal phasenumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PhaseTwo)) {
            return false;
        }
        PhaseTwo other = (PhaseTwo) object;
    ...
    public String toString() {
        return "alnayzak.PhaseTwo[ phasenumber=" + phasenumber + " ]";
    }
