 ...
 */
@Entity
@Table(name = "PHASE_THREE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PhaseThree.findAll", query = "SELECT p FROM PhaseThree p"),
    @NamedQuery(name = "PhaseThree.findByPhasenumber", query = "SELECT p FROM PhaseThree p WHERE p.phasenumber = :phasenumber")})
public class PhaseThree implements Serializable {
    ...
    public PhaseThree(BigDecimal phasenumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PhaseThree)) {
            return false;
        }
        PhaseThree other = (PhaseThree) object;
    ...
    public String toString() {
        return "alnayzak.PhaseThree[ phasenumber=" + phasenumber + " ]";
    }
