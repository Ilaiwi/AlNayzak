...
@NamedQueries({
    ...
    @NamedQuery(name = "Step.findByProjectnumber", query = "SELECT s FROM Step s WHERE s.projectnumber = :projectnumber"),
    @NamedQuery(name = "Step.findByMaterial", query = "SELECT s FROM Step s WHERE s.material = :material"),
    @NamedQuery(name = "Step.findByTSupport", query = "SELECT s FROM Step s WHERE s.tSupport = :tSupport"),
    @NamedQuery(name = "Step.findByYears", query = "SELECT s FROM Step s WHERE s.years = :years")})
public class Step implements Serializable {
    ...
    public Step(BigDecimal projectnumber) {
    ...
    public String toString() {
        return "alnayzak.Step[ projectnumber=" + projectnumber + " ]";
    }
