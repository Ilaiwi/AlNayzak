 ...
 */
@Entity
@Table(name = "PROJECTDEPARTMENT")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Projectdepartment.findAll", query = "SELECT p FROM Projectdepartment p"),
    @NamedQuery(name = "Projectdepartment.findByDepartmentnumber", query = "SELECT p FROM Projectdepartment p WHERE p.departmentnumber = :departmentnumber")})
public class Projectdepartment implements Serializable {
    ...
    public Projectdepartment(BigDecimal departmentnumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Projectdepartment)) {
            return false;
        }
        Projectdepartment other = (Projectdepartment) object;
    ...
    public String toString() {
        return "alnayzak.Projectdepartment[ departmentnumber=" + departmentnumber + " ]";
    }
