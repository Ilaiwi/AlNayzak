 ...
 * @author BaRa' DwEiKaT
 */
public class SStudentFrame extends javax.swing.JFrame {
    ...
    private void SearchStudentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchStudentButtonActionPerformed
            ...
            if(!this.IDTextField.getText().equals(""))
        {
            ...
            this.ResultTextArea.setText("ID: "+student.getPeopleid()+"\n"+
                    "Name: "+student.getFname()+" "+student.getMinname()+" "+student.getLname()+"\n"+
                    "Socaial Number: "+student.getEmployee().getSocialnumber()+"\n"+
