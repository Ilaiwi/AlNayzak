 ...
 * @author BaRa' DwEiKaT
 */
public class EditLocationFrame extends javax.swing.JFrame {
    ...
    public EditLocationFrame(Locations location) {
        initComponents();
        emf=Persistence.createEntityManagerFactory("AlNayzakPU");
        em=emf.createEntityManager();
        qr=em.createNamedQuery("Locations.findByLocationnumber");
        qr.setParameter("locationnumber", location.getLocationnumber());
        locations=(Locations) qr.getSingleResult();
        this.NumberTextField.setText(location.getLocationnumber()+"");
        this.NameTextField.setText(location.getLocationname()+"");
    ...
    private void initComponents() {
        ...
        EditLocationButton.setText("Save");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(EditLocationButton, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(EditLocationButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void EditLocationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditLocationButtonActionPerformed
        try{
            locations.setLocationnumber(BigDecimal.valueOf(Long.valueOf(this.NumberTextField.getText())));
        locations.setLocationname(this.NameTextField.getText());
